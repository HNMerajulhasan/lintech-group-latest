    ...
    <div className="relative">
      <main className={styles.main}>
        <HeaderTitle
          ...
          description="At Lintech Group, our luxury renovation process seamlessly integrates strategic planning, expert craftsmanship, and cutting-edge innovation, transforming spaces into timeless masterpieces through four key stages."
